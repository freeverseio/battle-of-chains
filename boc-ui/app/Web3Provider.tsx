...
// Define the LAOS Network chain
const laosChain: Chain = {
  id: 6283,
  name: "LAOS Network",
  nativeCurrency: {
    decimals: 18,
  ...
  rpcUrls: {
    public: { http: ["https://rpc.laos.laosfoundation.io"] },
    default: { http: ["https://rpc.laos.laosfoundation.io"] },
  },
  blockExplorers: {
    default: {
      name: "LAOS Explorer",
      ...
      <QueryClientProvider client={queryClient}>
        <ConnectKitProvider
          customTheme={{
            ...
            "--ck-connectbutton-font-size": "19px",
            "--ck-connectbutton-color": "#ffffff",
            "--ck-connectbutton-background": "#281A36",
            ...
            "--ck-connectbutton-hover-color": "#FE07DD",
            "--ck-connectbutton-hover-background": "#281A36",
            ...
            "--ck-primary-button-background": "#281A36",
            "--ck-primary-button-box-shadow": "0px 0px 0px 0px #ffffffe6",
            "--ck-primary-button-hover-color": "#FE07DD",
            "--ck-primary-button-hover-background": "#281A36",
            ...
            "--ck-secondary-button-background": "#281A36",
            "--ck-secondary-button-box-shadow": "0 0 0 0 #ffffff",
            "--ck-secondary-button-hover-color": "#FE07DD",
            "--ck-secondary-button-hover-background": "#281A36",
            ...
            "--ck-modal-box-shadow": "0px 2px 4px 0px #c7c7c7",
            "--ck-overlay-background": "#00000008",
            "--ck-body-color": "#02F6EC",
            "--ck-body-color-muted": "#999999",
            "--ck-body-color-muted-hover": "#FE07DD",
            "--ck-body-background": "#0D0020",
            "--ck-body-background-transparent": "rgba(255,255,255,0)",
            "--ck-body-background-secondary": "#FE07DD",
            ...
            "--ck-qr-dot-color": "#FE07DD",
            "--ck-qr-background": "#281A36",
            "--ck-qr-border-color": "#02F6EC",
            ...
            "--ck-recent-badge-border-radius": "32px", // Use the CSS variable here
          }}
        >
          {children}
        </ConnectKitProvider>
