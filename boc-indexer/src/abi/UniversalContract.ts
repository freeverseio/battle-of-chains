...
export const events = {
    ...
    AssignOperator: event("0x2b96b4fb3bb8142a02b704890a9bf3231258719c3c7dad852406b1ab44ef1dde", "AssignOperator(address,address)", {"_from": indexed(p.address), "_operator": indexed(p.address)}),
    ...
    SendGameTreasury: event("0x919b188bba1cc095e8479b98e7d4352e580f1306c871cdd3ab517d3df9884594", "SendGameTreasury(address,uint8,(address,uint256)[])", {"_from": indexed(p.address), "_method": p.uint8, "_sendTXs": p.array(p.struct({"recipient": p.address, "amount": p.uint256}))}),
...
export const functions = {
    ...
    assignOperator: fun("0x84385c6f", "assignOperator(address)", {"_operator": p.address}, ),
    ...
    sendGameTreasuryAbsolute: fun("0xcd56abc4", "sendGameTreasuryAbsolute((address,uint256)[])", {"_sendTXs": p.array(p.struct({"recipient": p.address, "amount": p.uint256}))}, ),
    sendGameTreasuryPercentage: fun("0xbbe511b0", "sendGameTreasuryPercentage((address,uint256)[])", {"_sendTXs": p.array(p.struct({"recipient": p.address, "amount": p.uint256}))}, ),
...
export type AssignOperatorEventArgs = EParams<typeof events.AssignOperator>
...
export type SendGameTreasuryEventArgs = EParams<typeof events.SendGameTreasury>
...
export type SendGameTreasuryAbsoluteParams = FunctionArguments<typeof functions.sendGameTreasuryAbsolute>
export type SendGameTreasuryAbsoluteReturn = FunctionReturn<typeof functions.sendGameTreasuryAbsolute>

export type SendGameTreasuryPercentageParams = FunctionArguments<typeof functions.sendGameTreasuryPercentage>
export type SendGameTreasuryPercentageReturn = FunctionReturn<typeof functions.sendGameTreasuryPercentage>
